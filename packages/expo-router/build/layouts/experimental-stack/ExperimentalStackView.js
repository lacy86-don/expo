...
function ScreenView({ routeKey, descriptor, options, isPreloaded, preventNativeDismiss, ...lifecycle }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(experimental_1.Stack.Screen, { activityMode: isPreloaded ? 'detached' : 'attached', screenKey: routeKey, preventNativeDismiss: preventNativeDismiss, ...lifecycle, children: [(0, jsx_runtime_1.jsx)(experimental_1.Stack.HeaderConfig, { ...headerConfigProps }), (0, jsx_runtime_1.jsx)(react_native_1.View, { style: styles.scene, children: descriptor.render() })] }));
}
