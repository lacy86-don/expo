import type { Calendar, Attendee, DialogEventResult, EntityTypes, Event, OpenEventDialogResult, PermissionResponse, RecurringEventOptions, Reminder, ReminderStatus } from '../Calendar';
import InternalExpoCalendar from './ExpoCalendar';
import type { ModifiableEventProperties, ModifiableReminderProperties, ModifiableCalendarProperties, CalendarDialogOpenParamsNext, CalendarDialogParamsNext, CalendarPermissionOptions, ModifiableAttendeeProperties, AddEventWithFormOptions } from './ExpoCalendar.types';
/**
