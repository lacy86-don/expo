...
- [iOS] Add support for using multiple inner app frameworks in one host app via the new `multipleFrameworks` property. ([@gabrieldonadel](https://github.com/gabrieldonadel)) ([#45347](https://github.com/expo/expo/pull/45347) by [@gabrieldonadel](https://github.com/gabrieldonadel))
